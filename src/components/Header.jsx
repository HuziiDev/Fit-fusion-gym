...
const Header = () => {
  ...
  return (
    ...
    <div className='hero w-full h-[40rem] bg-black overflow-x-hidden  flex   '> 
    <div className="hero-content w-[60%] md:w-[50%]   md:block    z-10 content mt-44  ml-44 ">
        <h1 className='sm:text-4xl md:text-5xl  text-white font-medium'>Fitness and Health</h1>
